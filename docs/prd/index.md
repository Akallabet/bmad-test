...
- [Simple To-Do App to Demonstrate the BMAD Method Product Requirements Document (PRD)](#table-of-contents)
  ...
  - [User Interface Design Goals](./user-interface-design-goals.md)
    ...
    - [Accessibility: None (MVP scope)](./user-interface-design-goals.md#accessibility-none-mvp-scope)
